...
XPERL_CMD_TEST		= "test"
XPERL_TEST_MODE_ON	= "Raid test mode |c0000FF00on|r - two sample groups with sample buffs and debuffs. Set up Buff/Debuff Position and Size on the Raid tab and the samples follow along. |c00FFFFFF/xperl test|r again to turn it off."
...
XPERL_CMD_HELP		= "|c00FFFF80Usage: |c00FFFFFF/xperl menu | lock | unlock | test | config list | config delete <realm> <name>"
