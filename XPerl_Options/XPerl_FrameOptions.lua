...
-- maxFactor lets a frame scale beyond the global maximum scale, e.g. 1.5 for 50% extra headroom
function XPerl_Options_RegisterScalingSlider(self, min, max, maxFactor)
	...
	if (max) then
		...
		max = floor(((XPerlDB and XPerlDB.maximumScale) or 1.5) * 100 * (self.maxFactor or 1) + 0.5)
	end
...
--			hideClassBuffs	= nil,			-- Off likewise. Shields, armors, shouts, seals, forms
